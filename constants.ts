...
export const MOCK_PLATFORMS: Platform[] = [
  {
    ...
    remainingQty: 45,
    totalQty: 100,
    steps: ['Klik "Ambil Misi" & Download APK', 'Daftar pakai No HP', 'Deposit Min 50rb', 'Upload SS Bukti Transfer'],
  ...
  },
  {
    ...
    remainingQty: 12,
    totalQty: 50,
    steps: ['Daftar Akun', 'Depo 20rb', 'Mainkan 5x spin'],
  ...
  },
  {
    ...
    remainingQty: 88,
    totalQty: 200,
    steps: ['Download & Install', 'Login Tamu', 'SS Lobby'],
